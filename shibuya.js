...
const BUILDINGS = [
  { num: '01', nameEn: 'Miyashita Park', tag: 'Mixed Use · 2020', lat: 35.6598, lon: 139.7043, intensity: 0.9 },
  { num: '02', nameEn: 'Jingu-dori Park Toilet', tag: 'Public Facility · 2020', lat: 35.6655, lon: 139.7042, intensity: 0.6 },
  { num: '03', nameEn: 'Casa Jingumae', tag: 'Residential · 2007', lat: 35.6671, lon: 139.7060, intensity: 0.65 },
  { num: '04', nameEn: 'Sia Aoyama Building', tag: 'Commercial · 2003', lat: 35.6641, lon: 139.7073, intensity: 0.75 },
  { num: '05', nameEn: 'United Nations University', tag: 'Education · 1992', lat: 35.6640, lon: 139.7100, intensity: 0.7 },
  { num: '06', nameEn: 'Tokyo Metro Shibuya Station', tag: 'Transport · 2008', lat: 35.6580, lon: 139.7016, intensity: 1.0 },
];
...
const LAT_COS = Math.cos(35.66 * Math.PI / 180);
...
function drawWardLabel(name, lon, lat) {
  ...
  ctx.save(); ctx.font = '500 10px "Pretendard", sans-serif'; ctx.letterSpacing = '0.10em';
...
function drawWard(geojson) {
  ...
  drawWardLabel('Shibuya', 139.710, 35.662);
}
