...
(function () {
  ...
  const BUILDINGS = [
    ...
    /* ─ Asakusa (asakusa.html) ─ */
    {
      ...
      district: 'Asakusa',
      architect: 'Tokyo Metro',
      year: '1930',
      href: 'asakusa.html#building-01',
      images: [
        'picture/Tokyo_Metro_Asakusa_Station_Exit4_01.png',
        'picture/Tokyo_Metro_Asakusa_Station_Exit4_02.png',
        'picture/Tokyo_Metro_Asakusa_Station_Exit4_03.png',
        'picture/Tokyo_Metro_Asakusa_Station_Exit4_04.png',
        'picture/Tokyo_Metro_Asakusa_Station_Exit4_05.png',
        'picture/Tokyo_Metro_Asakusa_Station_Exit4_06.png',
      ],
    },
    {
      name: 'Asahi Super Dry Hall',
      district: 'Asakusa',
      architect: 'Philippe Starck',
      year: '1989',
      href: 'asakusa.html#building-02',
      images: [
        'picture/Asahi_Super_Dry_Hall_01.png',
        'picture/Asahi_Super_Dry_Hall_02.png',
        'picture/Asahi_Super_Dry_Hall_03.png',
        'picture/Asahi_Super_Dry_Hall_04.png',
      ],
    },
    {
      name: 'Asakusa Culture Center',
      district: 'Asakusa',
      architect: 'Kengo Kuma',
      year: '2012',
      href: 'asakusa.html#building-03',
      images: [
        'picture/Asakusa_Culture_Information_Center_01.png',
        'picture/Asakusa_Culture_Information_Center_02.png',
        'picture/Asakusa_Culture_Information_Center_03.png',
        'picture/Asakusa_Culture_Information_Center_04.png',
        'picture/Asakusa_Culture_Information_Center_05.png',
        'picture/Asakusa_Culture_Information_Center_06.png',
        'picture/Asakusa_Culture_Information_Center_07.png',
      ],
    },
    {
      name: 'Asakusa Senso-Ji',
      district: 'Asakusa',
      architect: 'RC Reconstruction',
      year: '1958',
      href: 'asakusa.html#building-04',
      images: [
        'picture/Asakusa_Senso-Ji_01.png',
        'picture/Asakusa_Senso-Ji_02.png',
        'picture/Asakusa_Senso-Ji_03.png',
        'picture/Asakusa_Senso-Ji_04.png',
        'picture/Asakusa_Senso-Ji_05.png',
        'picture/Asakusa_Senso-Ji_06.png',
      ],
    },
    {
      name: 'Fuglen Asakusa / Sauna Reset Pint',
      district: 'Asakusa',
      architect: 'Akihisa Hirata',
      year: '2019',
      href: 'asakusa.html#building-05',
      images: [
        'picture/Fuglen_Asakusa_Sauna_Reset_Pint_01.png',
        'picture/Fuglen_Asakusa_Sauna_Reset_Pint_02.png',
        'picture/Fuglen_Asakusa_Sauna_Reset_Pint_03.png',
        'picture/Fuglen_Asakusa_Sauna_Reset_Pint_04.png',
        'picture/Fuglen_Asakusa_Sauna_Reset_Pint_05.png',
        'picture/Fuglen_Asakusa_Sauna_Reset_Pint_06.png',
        'picture/Fuglen_Asakusa_Sauna_Reset_Pint_07.png',
      ],
    },
    {
      name: 'Kura Sushi Asakusa ROX',
      district: 'Asakusa',
      architect: 'Kashiwa Sato',
      year: '2022',
      href: 'asakusa.html#building-06',
      images: [
        'picture/Kura_Sushi_Asakusa_ROX_Flagship_store_01.png',
        'picture/Kura_Sushi_Asakusa_ROX_Flagship_store_02.png',
        'picture/Kura_Sushi_Asakusa_ROX_Flagship_store_03.png',
        'picture/Kura_Sushi_Asakusa_ROX_Flagship_store_04.png',
        'picture/Kura_Sushi_Asakusa_ROX_Flagship_store_05.png',
        'picture/Kura_Sushi_Asakusa_ROX_Flagship_store_06.png',
        'picture/Kura_Sushi_Asakusa_ROX_Flagship_store_07.png',
        'picture/Kura_Sushi_Asakusa_ROX_Flagship_store_08.png',
        'picture/Kura_Sushi_Asakusa_ROX_Flagship_store_09.png',
        'picture/Kura_Sushi_Asakusa_ROX_Flagship_store_10.png',
      ],
    },
  ];
