 ...
 * akihabara.js
 *
 * 역할: 히어로 우측 2D 캔버스 맵 (千代田区 GeoJSON + 건물 파티클)
 */

const BUILDINGS = [
  {
    num:       '01',
    nameEn:    'mAAch Ecute Kanda Manseibashi',
    tag:       'Heritage · 2013 (Renovation)',
    lat:       35.6997,
    lon:       139.7713,
    intensity: 1.00,
  },
  ...
  {
    num:       '03',
    nameEn:    'Restaurant KUFUKU±',
    tag:       'Restaurant · 2019 (Renovation)',
    lat:       35.7013,
    lon:       139.7762,
    intensity: 0.75,
  },
...
const LAT_COS = Math.cos(35.70 * Math.PI / 180);
...
function drawWard(geojson) {
  ...
  drawWardLabel('Chiyoda', 139.768, 35.700);
  drawWardLabel('Taito', 139.787, 35.704);
}
